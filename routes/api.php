...
// Blog covers generated by the assistant. Same storage/ reasoning as above.
Route::get('/media/blog/{file}', [\App\Http\Controllers\Api\AdminAiController::class, 'serve'])
    ->where('file', '[A-Za-z0-9._-]+');
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware(\App\Http\Middleware\EnsureAdmin::class)->prefix('admin')->group(function () {
        ...
        // The Content tab's assistant. Throttled hard: each call costs a
        // provider request, and these are the only routes that can spend money.
        Route::post('/ai/blog-draft',  [\App\Http\Controllers\Api\AdminAiController::class, 'draft'])->middleware('throttle:12,1');
        Route::post('/ai/cover-image', [\App\Http\Controllers\Api\AdminAiController::class, 'coverImage'])->middleware('throttle:8,1');
