...
export const BOARDS = [
  ...
  {
    slug: 'igcse', name: 'IGCSE / Cambridge', icon: '🌍',
  ...
  {
    slug: 'state-boards', name: 'State Boards', icon: '📍',
...
// The academic category slugs whose courses a board page surfaces.
