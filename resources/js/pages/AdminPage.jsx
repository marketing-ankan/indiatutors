  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mt-5 flex flex-wrap gap-2 border-b border-slate-100">
        {[['demos','Demo Requests'],['orders','Orders'],['events','Events'],['videos','Video Courses'],['teachers','Teacher Applications'],['proposals','Course Proposals'],['exams','Exam Updates'],['analytics','Analytics']].map(([k,label]) => (
