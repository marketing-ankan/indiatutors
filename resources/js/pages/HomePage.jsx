...
export default function HomePage() {
  ...
  const TRUST = [
    ...
    ['8,000+', 'Students Trained'], ['200+', 'Free Workshops Run'], ['4.9 ★', 'Google Rating'],
  ];
        ...
        <div className="relative container-wide py-16 lg:py-24 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-4 flex items-center gap-3" aria-label="Rated 4.7 on Google and Trustpilot">
              <span className="flex items-center gap-1.5"><GoogleG /><Stars /><strong className="text-sm">4.7</strong></span>
              <span className="h-4 w-px bg-white/30" aria-hidden="true" />
              <span className="flex items-center gap-1 text-sm text-white/90 font-semibold">
                <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true"><path fill="#00B67A" d="M12 1.5l2.7 7.1H22l-6 4.6 2.3 7.3-6.3-4.6-6.3 4.6L7.9 13.2 2 8.6h7.3z"/></svg>
                Trustpilot
              </span>
            </div>
          </div>
