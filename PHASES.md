...
- ⬜ Left: create the Cloudflare R2 bucket + set R2_ACCOUNT_ID/BUCKET/ACCESS_KEY_ID/SECRET_ACCESS_KEY (then paid playback goes live); upload real lesson videos; optional dashboard “My Courses” UI. Bunny stays wired as the paid upgrade path (adaptive bitrate) if buffering complaints appear.
